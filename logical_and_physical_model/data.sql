...
VALUES
  ((SELECT rental_id FROM rental WHERE student_id = (SELECT student_id FROM student WHERE person_id = (SELECT person_id FROM person WHERE first_name = 'Chancellor' AND last_name = 'Sims'))), (SELECT instrument_id FROM instrument WHERE instrument_name = 'guitar')),
  ((SELECT rental_id FROM rental WHERE student_id = (SELECT student_id FROM student WHERE person_id = (SELECT person_id FROM person WHERE first_name = 'Allistair' AND last_name = 'Carroll'))), (SELECT instrument_id FROM instrument WHERE instrument_name = 'flute'));
